...
*facts* (behind a one-method `IDialectExtractor`). Everything else — graph assembly, the frontier,
the spider loop, the connected-components closure audit, lineage, `viz` — is dialect-neutral.
